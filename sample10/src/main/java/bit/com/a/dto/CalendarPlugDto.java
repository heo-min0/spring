...
public class CalendarPlugDto implements Serializable {
	...
	private String title, content, startdate, enddate, wdate;
	
	public CalendarPlugDto() {	}
	public CalendarPlugDto(int seq, String id, int slevel, String title, String content, String startdate, String enddate, String wdate) {
		this.seq = seq;
		this.id = id;
		this.slevel = slevel;
		this.title = title;
	...
	public void setSlevel(int slevel) {this.slevel = slevel;}
...
VALUES(SEQ_CALPLUG.NEXTVAL,'aaa',1,'사업미팅','제품계약서건','2021-04-24T12:30:00','',SYSDATE);

INSERT INTO CALENDARPLUG(SEQ,ID,SLEVEL,TITLE,CONTENT,STARTDATE,ENDDATE,WDATE)
VALUES(SEQ_CALPLUG.NEXTVAL,'aaa',1,'국내여행','대포항으로','2021-04-26T08:30:00','2021-04-30T16:30:00',SYSDATE);

INSERT INTO CALENDARPLUG(SEQ,ID,SLEVEL,TITLE,CONTENT,STARTDATE,ENDDATE,WDATE)
VALUES(SEQ_CALPLUG.NEXTVAL,'aaa',1,'연수','워크샵','2021-04-19','',SYSDATE);
*/
