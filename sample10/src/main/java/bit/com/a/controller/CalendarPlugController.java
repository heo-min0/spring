...
public class CalendarPlugController {
	...
	@RequestMapping(value = "calendarpulglist.do", method = RequestMethod.GET)
	public String calendarpulglist(Model model, HttpSession session) {
